...
from smartbot import BOT_USERNAME, OWNER_ID
from smartbot.config import get_str_key
from smartbot.function.pluginhelpers import convert_seconds_to_minutes as time_convert
from smartbot.function.pluginhelpers import fetch
...
async def alive_function(answers):
    ...
    msg = f"""
**[xkaykay✨](https://github.com/famouskaykay):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/famouskaykay3)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
