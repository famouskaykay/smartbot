...
PM_START_TEXT = """
Hello I'm xkaykay ,
༒︎ I ᴀᴍ ᴍᴜʟᴛɪ powerful ʙᴏᴛ ᴡɪᴛʜ ᴏsᴍ ғᴇᴀᴛᴜʀᴇs[.](https://telegra.ph/file/bfd2b8688249cbfb901b0.jpg)
➪ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴍᴀᴋᴇ ᴀᴅᴍɪɴ ᴛᴏ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴡɪᴛʜ ᴇxᴘʟᴏsɪᴠᴇ.
➪ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [developer](t.me/famouskaykay3) ғᴏʀ ᴀɴʏ ǫᴜᴇʀʏ ᴀɴᴅ [ᴀᴘᴘᴇᴀʟ](https://t.me/KayAspirerProject) ʜᴇʀᴇ.
➪ ᴄʟɪᴄᴋ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ʜᴇʟᴘ ᴛᴏ ᴇxᴘʟᴏʀᴇ ᴍᴏʀᴇ ᴀʙᴏᴜᴛ ᴍᴇ ᴀɴᴅ ᴍʏ ғᴇᴀᴛᴜʀᴇs.
➪ Pᴏᴡᴇʀᴇᴅ ʙʏ [intimay](https://t.me/joinchat/UUVAYIXEoC9kNWI0)
"""

buttons = [
    [
        InlineKeyboardButton(
            text="➕️ Aᴅᴅ xkaykay to yo group ➕️", url="t.me/xkaykaybot?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="👥Sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ👥", url="https://t.me/KayAspirerProject"),
    ],
    [
        InlineKeyboardButton(text="movies", url="https://t.me/intimacyfolksmovies"
    ), 
    ],
    [   
        InlineKeyboardButton(text="🔔Uᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ🔔", url="https://t.me/xprograming"
    ),
    ],
]
...
HELP_STRINGS = """
༆*xkaykay comes with many special features in it*༆
꧁*CHECK ALL BUTTON BELOW TO EXPLORE EVERY COMMANDS OF LOVELY*꧂
𖣘 *All commands can either be used with* `/` *or* `!`.
𖣘 *If you facing any issue or find any bugs in any command then you can report it in @famouskaykay3* [.](https://telegra.ph/file/cbbf01ed6f013ce07d54f.jpg)
"""
...
def Masha_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "masha_":
        query.message.edit_text(
            text=""" ℹ️ I'm *xkaykay*, a powerful group management bot built to help you manage your group easily.
                 ...
                 contact [developer](https://t.me/famouskaykay3) for any questions.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1917528355 and DONATION_LINK:
            update.effective_message.reply_text(
