...
import smartbot.modules.sql.connection_sql as sql
from smartbot import DEV_USERS, DRAGONS, dispatcher
from smartbot.modules.helper_funcs import chat_status
from smartbot.modules.helper_funcs.alternate import send_message, typing_action
    ...
    if update.effective_chat.type == "private":
        ...
        if (isadmin) or (isallow and ismember) or (user.id in DRAGONS):
            ...
            if connection_status:
                ...
                send_message(
                    update.effective_message,
                    "Successfully connected to *{}*.@szrosebot".format(chat_name),
                    parse_mode=ParseMode.MARKDOWN,
                )
                try:
